...
import { ViaEmpreinteService } from '../../shared/Services/Pointage/via-empreinte.service';
import { ProgressStatus } from '../../shared/Interfaces/progress-status';
import { HttpClient, HttpEventType } from '@angular/common/http';
import { PathSharedService } from '../../shared/path-shared.service';
import { UploadDownloadService } from '../../shared/Services/Taches/upload-download.service';
import { ProgressStatusEnum } from '../../shared/Enum/progress-status-enum.enum';
import { ViaEmpreinte } from '../../shared/Models/Pointage/via-empreinte.model';
...
export class AddPointageEmpComponent implements OnInit {
  ...
  constructor(private viaempService: ViaEmpreinteService,
  ...
  listdate: ViaEmpreinte[] = [];
  listdate2: ViaEmpreinte[] = [];
  ...
  listdate4: ViaEmpreinte[] = [];
  listdate3: ViaEmpreinte[] = [];
  ...
  listdate5: ViaEmpreinte[] = [];
  listdate6: ViaEmpreinte[] = [];
...
setradio(e: string): void {
  ...
  empList: ViaEmpreinte[] = [];
  empListFile: ViaEmpreinte[] = [];
  Submit() {
  ...
  getDatabyDate(date) {
    ...
    this.viaempService.getDataByDate(date).subscribe(res => {
      console.log(res)
    })
  }
  //Files
