...
import { DemCongeListAccepteComponent } from './RhDirServicesList/dem-conge-list-accepte/dem-conge-list-accepte.component';
import { DemCongeListRefuseComponent } from './RhDirServicesList/dem-conge-list-refuse/dem-conge-list-refuse.component';
import { DemPermissionListRefuseComponent } from './RhDirServicesList/dem-permission-list-refuse/dem-permission-list-refuse.component';
import { DemPermissionListAccepteComponent } from './RhDirServicesList/dem-permission-list-accepte/dem-permission-list-accepte.component';
import { DemRecrutementListAccepteComponent } from './RhDirServicesList/dem-recrutement-list-accepte/dem-recrutement-list-accepte.component';
import { DemRecrutementListRefuseComponent } from './RhDirServicesList/dem-recrutement-list-refuse/dem-recrutement-list-refuse.component';
import { DemEquipementListRefuseComponent } from './RhDirServicesList/dem-equipement-list-refuse/dem-equipement-list-refuse.component';
import { DemEquipementListAccepteComponent } from './RhDirServicesList/dem-equipement-list-accepte/dem-equipement-list-accepte.component';
import { DemSalarialeListAccepteComponent } from './RhDirServicesList/dem-salariale-list-accepte/dem-salariale-list-accepte.component';
import { DemSalarialeListRefuseComponent } from './RhDirServicesList/dem-salariale-list-refuse/dem-salariale-list-refuse.component';
import { DemResidenceListRefuseComponent } from './RhDirServicesList/dem-residence-list-refuse/dem-residence-list-refuse.component';
import { DemResidenceListAccepteComponent } from './RhDirServicesList/dem-residence-list-accepte/dem-residence-list-accepte.component';
import { DemPayChequeListAccepteComponent } from './RhDirServicesList/dem-pay-cheque-list-accepte/dem-pay-cheque-list-accepte.component';
import { DemPayChequeListRefuseComponent } from './RhDirServicesList/dem-pay-cheque-list-refuse/dem-pay-cheque-list-refuse.component';
import { DemcrefinanListRefuseComponent } from './RhDirServicesList/demcrefinan-list-refuse/demcrefinan-list-refuse.component';
import { DemcrefinanListAccepteComponent } from './RhDirServicesList/demcrefinan-list-accepte/demcrefinan-list-accepte.component';
import { DemFormationListAccepteComponent } from './RhDirServicesList/dem-formation-list-accepte/dem-formation-list-accepte.component';
import { DemFormationListRefuseComponent } from './RhDirServicesList/dem-formation-list-refuse/dem-formation-list-refuse.component';
import { DemExperienceListRefuseComponent } from './RhDirServicesList/dem-experience-list-refuse/dem-experience-list-refuse.component';
import { DemExperienceListAccepteComponent } from './RhDirServicesList/dem-experience-list-accepte/dem-experience-list-accepte.component';
import { DemDemissionListAccepteComponent } from './RhDirServicesList/dem-demission-list-accepte/dem-demission-list-accepte.component';
import { DemDemissionListRefuseComponent } from './RhDirServicesList/dem-demission-list-refuse/dem-demission-list-refuse.component';
import { DemPlaintListRefuseComponent } from './RhDirServicesList/dem-plaint-list-refuse/dem-plaint-list-refuse.component';
import { DemPlaintListAccepteComponent } from './RhDirServicesList/dem-plaint-list-accepte/dem-plaint-list-accepte.component';
...
@NgModule({
  declarations: [
    ...
    DemCongeListAccepteComponent,
    DemCongeListRefuseComponent,
    DemcrefinanListAccepteComponent,
    DemcrefinanListRefuseComponent,
    DemDemissionListAccepteComponent,
    DemDemissionListRefuseComponent,
    DemEquipementListAccepteComponent,
    DemSalarialeListRefuseComponent,
    DemSalarialeListAccepteComponent,
    DemResidenceListRefuseComponent,
    DemResidenceListAccepteComponent,
    DemRecrutementListRefuseComponent,
    DemRecrutementListAccepteComponent,
    DemPlaintListRefuseComponent,
    DemPlaintListAccepteComponent,
    DemPermissionListRefuseComponent,
    DemPermissionListAccepteComponent,
    DemPayChequeListRefuseComponent,
    DemPayChequeListAccepteComponent,
    DemFormationListRefuseComponent,
    DemFormationListAccepteComponent,
    DemExperienceListRefuseComponent,
    DemExperienceListAccepteComponent,
    DemEquipementListRefuseComponent,
  ...
  imports: [
    ...
    RouterModule.forRoot([
     ...
     // { path: '', component: UserRegisterComponent, pathMatch: 'full' },
      ...
      { path: 'tasks-list-created', component: TasksListCreatedComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tasks-list-received', component: TasksListReceivedComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tasks-list-done', component: TasksListDoneComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tasks-list-delayed', component: TasksListDelayedComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'user-registration', component: UserRegistrationComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE'] }  },
      ...
      { path: 'alertsrh', component: AlertsrhComponent, canActivate: [AuthGuard] },
      ...
      { path: 'task-details/:id', component: TaskDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'task-details', component: TaskDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tasks-list', component: TasksListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'new-task', component: NewTaskComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'main-tasks', component: MainTasksComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE','SECRETAIRE'] } },
      ...
      { path: 'liste-dotation', component: ListeDotationComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }},
      ...
      { path: 'revenus-list', component: RevenusListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enregistrer-revenus', component: EnregistrerRevenusComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE'] } },
      ...
      { path: 'edit-revenus', component: EditRevenusComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
  ...
  { path: 'employee-update', component: EmployeeUpdateComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] } },
     ...
     { path: 'employee-add', component: EmployeeAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] }  },
      ...
      { path: 'enregistrer-tr-recue', component: EnregistrerTRRecueComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'my-liste-tr', component: MyListeTrComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'my-liste-tr-emise', component: MyListeTrEmiseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enregistrer-tre', component: EnregistrerTREComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }  },
      { path: 'enregistrer-tri', component: EnregistrerTRIComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }  },
      { path: 'my-liste-tr-i', component: MyListeTrIComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'my-liste-decision', component: MyListeDecisionComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      ...
      { path: 'transactions-rlist', component: TransactionsRListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-def-r', component: EnregDefRComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-temp-r', component: EnregTempRComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-r', component: EnregRComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'afftected-to-my-admin-r', component: AfftectedToMyAdminRComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },

      { path: 'transactions-elist', component: TransactionsElistComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-e', component: EnregEComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'afftected-to-my-admin-e', component: AfftectedToMyAdminEComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-temp-e', component: EnregTempEComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-def-e', component: EnregDefEComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'rappot-emise', component: RappotEmiseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      ...
      { path: 'enreg-def-i', component: EnregDefIComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }},
      { path: 'enreg-temp-i', component: EnregTempIComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'enreg-i', component: EnregIComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'affected-to-my-admin-i', component: AffectedToMyAdminIComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
  ...
  { path: 'tbl-main', component: TblMainComponent, canActivate: [AuthGuard] },
      ...
      { path: 'event-register', component: EventRegisterComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'EMPLOYEE','PARTRESP','DIRECTOR','SECRETAIRE'] }},

      { path: 'event-details', component: EventDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'EMPLOYEE','PARTRESP','DIRECTOR', 'SECRETAIRE', 'RESPFINANCE', 'PARTNORMAL'] } },

      { path: 'event-details/:id', component: EventDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'EMPLOYEE', 'PARTRESP','DIRECTOR', 'SECRETAIRE', 'RESPFINANCE', 'PARTNORMAL'] } },

      { path: 'event-list', component: EventListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'EMPLOYEE', 'DIRECTOR', 'PARTRESP','SECRETAIRE', 'RESPFINANCE','PARTNORMAL'] }},
      ...
      { path: 'menurequests', component: MenurequestsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'DIRECTORADMN', 'DIRECTORETAB', 'DIRECTORGENERAL'] } },
      ...
      { path: 'news-add', component: NewsAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      ...
      { path: 'cars-add', component: CarsAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE','PARTRESP'] }  },
      ...
      { path: 'main-accepted', component: MainAcceptedComponent, canActivate: [AuthGuard]/*, data: { permittedRoles: ['RESSOURCEHUMAINE'] }*/ },
      ...
      { path: 'event-two-add', component: EventTwoAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      ...
      { path: 'crud-events-two', component: CrudEventsTwoComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },

      { path: 'crud-news', component: CrudNewsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
    ...
    /************************* Projet ************************/
      ...
      { path: 'projet-add2', component: ProjetAdd2Component, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'SECRETAIRE', 'RESSOURCEHUMAINE', 'DIRECTOR', 'EMPLOYEE', 'PARTRESP'] }  },

      { path: 'projet-list', component: ProjetListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE', 'EMPLOYEE'] } },

      { path: 'projet-details', component: ProjetDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE','EMPLOYEE'] }},

      { path: 'projet-details/:id', component: ProjetDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
  ...
  { path: 'projet-compte', component: ProjetCompteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] } },
    ...
    /******** Finance2 **************/
      ...
      { path: 'comptes-list', component: ComptesListComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },

      { path: 'etat-comptes-add', component: EtatComptesAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE', 'PARTRESP'] } },
  ...
  { path: 'etat-compte-settings', component: EtatCompteSettingsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] }},
      ...
      { path: 'service-banque-add', component: ServiceBanqueAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE','PARTRESP'] }  },
    ...
    /************************ Cheques ****************************/
      ...
      { path: 'chequec-add', component: ChequecAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE','PARTRESP'] } },

      { path: 'chequec-lis', component: ChequecLisComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      ...
      { path: 'chequec-details', component: ChequecDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },

      { path: 'chequec-details/:id', component: ChequecDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }},

      { path: 'pay-chequec-add', component: PayChequecAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE','PARTRESP'] }  },
  ...
  { path: 'chequeclasse', component: ChequeclasseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] }},
    ...
    /******** Salaire *****************/
      ...
      { path: 'salaire-add', component: SalaireAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'DIRECTOR', 'SECRETAIRE','PARTRESP'] } },
    ...
    /********* User Service Part 2  ***********/
      ...
      { path: 'salaire-report-print', component: SalaireReportPrintComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] }  },

      { path: 'demissio-list', component: DemissioListComponent, canActivate: [AuthGuard] },

      { path: 'demissio-listdir', component: DemissioListdirComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] }  },
      ...
      { path: 'residence-list-dir', component: ResidenceListDirComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] }  },

      { path: 'experience-add', component: ExperienceAddComponent, canActivate: [AuthGuard] },

      { path: 'experience-print', component: ExperiencePrintComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] }  },

      { path: 'langue-ev', component: LangueEvComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR'] } },

      { path: 'tache-global-details', component: TacheGlobalDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }},
      { path: 'tache-global-details/:id', component: TacheGlobalDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tache-received-details', component: TacheReceivedDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tache-received-details/:id', component: TacheReceivedDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },

      { path: 'tache-arecevoir-details', component: TacheARecevoirDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      { path: 'tache-arecevoir-details/:id', component: TacheARecevoirDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },


      //locataire 2

      { path: 'locataire-dot-add', component: LocataireDotAddComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'RESP', 'SECRETAIRE'] }},

      { path: 'locataire-dot-details', component: LocataireDotDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] }},

      { path: 'locataire-dot-details/:id', component: LocataireDotDetailsComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
      ...
      { path: 'tasks-in-progress', component: TasksInProgressComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },

      { path: 'tasks-not-done', component: TasksNotDoneComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'EMPLOYEE', 'RESSOURCEHUMAINE', 'CONSEILADMIN', 'SUPCONSEILADMIN', 'DIRECTOR', 'PARTRESP', 'PARTNORMAL', 'RESP', 'RESPFINANCE', 'SECRETAIRE'] } },
    ...
    /******************* OrgPart *******************/
      ...
      { path: 'dem-conge-list-accepte', component: DemCongeListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-conge-list-refuse', component: DemCongeListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-permission-list-refuse', component: DemPermissionListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-permission-list-accepte', component: DemPermissionListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-recrutement-list-accepte', component: DemRecrutementListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-recrutement-list-refuse', component: DemRecrutementListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-equipement-list-refuse', component: DemEquipementListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-equipement-list-accepte', component: DemEquipementListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-salariale-list-accepte', component: DemSalarialeListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-salariale-list-refuse', component: DemSalarialeListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-residence-list-refuse', component: DemResidenceListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-residence-list-accepte', component: DemResidenceListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-pay-cheque-list-accepte', component: DemPayChequeListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-pay-cheque-list-refuse', component: DemPayChequeListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'demcrefinan-list-refuse', component: DemcrefinanListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'demcrefinan-list-accepte', component: DemcrefinanListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-formation-list-accepte', component: DemFormationListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-formation-list-refuse', component: DemFormationListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-experience-list-refuse', component: DemExperienceListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-experience-list-accepte', component: DemExperienceListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-demission-list-accepte', component: DemDemissionListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-demission-list-refuse', component: DemDemissionListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-plaint-list-refuse', component: DemPlaintListRefuseComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },

      { path: 'dem-plaint-list-accepte', component: DemPlaintListAccepteComponent, canActivate: [AuthGuard], data: { permittedRoles: ['ADMINISTRATEUR', 'RESSOURCEHUMAINE'] } },
